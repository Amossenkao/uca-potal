        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-4 border-b border-border">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold">UCA</h2>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1">
                  ...
                  <div className="ml-8 space-y-1">
                    <a href="#" className="flex items-center gap-2 p-2 text-sm hover:bg-muted rounded-lg transition-colors" onClick={closeSidebar}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                {/* Large screens: Show "Upstairs" */}
                <h1 className="text-xl font-bold hidden lg:block">Upstairs</h1>
                {/* Medium and small screens: Show "UCA" */}
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <a href="#facilities" className="flex items-center gap-2 text-sm font-medium hover:text-primary transition-colors">
                <Building className="h-4 w-4" />
                Facilities
              </a>
              <a href="#team" className="flex items-center gap-2 text-sm font-medium hover:text-primary transition-colors">
                <Users className="h-4 w-4" />
                Team
              </a>
              <a href="#contact" className="flex items-center gap-2 text-sm font-medium hover:text-primary transition-colors">
