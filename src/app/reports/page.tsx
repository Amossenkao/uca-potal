      ...
      try {
        ...
        if (response.data) {
          ...
          if (studentData.grades && studentData.grades[0]) {
            ...
            const transformedSubjects = subjectNames.map(subjectName => ({
              name: subjectName,
              firstSemester: {
        ...
        <Page size="A4" orientation="landscape" style={styles.page}>
          ...
          <View style={styles.topRow}>
            <View style={styles.headerLeft}>
              ...
              <Text>Class: {student.grade || 'N/A'}</Text>
          ...
          <View style={styles.pageTwoContainer}>
            ...
            <View style={{ flex: 1, marginLeft: 10, borderWidth: 1, borderColor: '#000', padding: 10 }}>
              ...
              <View style={styles.studentInfo}>
                <Text>Name: {student.firstName} {student.middleName} {student.lastName} ID: {student.id}</Text>
                <Text>Class: {student.grade || 'N/A'} Academic Year: {student.academicYear || '2024/2025'}</Text>
              </View>
